...
export default function Page() {
  ...
  <div>
     <Home />
       ...
       <div className="fixed right-5 bottom-[15%] z-50 flex flex-col gap-3">
        ...
        <Link
          ...
          className="flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 shadow-lg shadow-gray-800/50 transition-transform duration-200 hover:scale-105"
        >
